package com.atthapon.alphonsevalidator.extention
...
fun String.nonEmpty(callback: (message: String) -> Unit, errorMsg: String? = null): Boolean {
    return validator().nonEmpty(errorMsg)
        .addErrorCallback { callback.invoke(it) }
        .check()
}
...
fun String.nonBlank(errorMsg: String? = null): Boolean {
    return validator().nonBlank(errorMsg).check()
}

fun String.nonBlank(callback: (message: String) -> Unit, errorMsg: String? = null): Boolean {
    return validator().nonBlank(errorMsg)
        .addErrorCallback { callback.invoke(it) }
        .check()
}

fun String.nonBlank(callback: (message: String) -> Unit): Boolean {
    return validator().nonBlank()
        .addErrorCallback { callback.invoke(it) }
        .check()
}
...
fun String.endWith(target: String, errorMsg: String? = null): Boolean {
    return validator().endsWith(target, errorMsg).check()
}

fun String.endWith(target: String, callback: (message: String) -> Unit, errorMsg: String? = null): Boolean {
    return validator().endsWith(target, errorMsg)
        .addErrorCallback { callback.invoke(it) }.check()
}

fun String.endWith(target: String, callback: (message: String) -> Unit): Boolean {
